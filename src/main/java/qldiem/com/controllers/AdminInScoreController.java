...
import qldiem.com.constans.GlobalConstans;
import qldiem.com.daos.DiemDAO;
import qldiem.com.daos.GiangVienDAO;
import qldiem.com.daos.HocKyDAO;
import qldiem.com.daos.MonHocDAO;
import qldiem.com.daos.NamHocDAO;
import qldiem.com.daos.TheLoaiDAO;
import qldiem.com.daos.TinChiDAO;
import qldiem.com.models.Khoa;
import qldiem.com.models.Lop;
import qldiem.com.models.diem;
import qldiem.com.models.giangvien;
import qldiem.com.models.hocky;
import qldiem.com.models.monhoc;
import qldiem.com.models.namhoc;
import qldiem.com.models.sinhvien;
import qldiem.com.models.theloai;
import qldiem.com.models.tinchi;
...
public class AdminInScoreController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (!"".equals(fileName)) {
			// lay thong tin thanh cac danh sach
		...
		for (diem diem : filexExx) {
			...
			diem.setMonhoc(new monhoc(maMonHoc, null, new tinchi(null, 0), new theloai(null, null)));
			...
			diem objDiem = new diem(0, diem.getHeso1(), diem.getHeso3(), diem.getHeso6(), diem.getTongDiem(),
					...
					new monhoc(maMonHoc, null, new tinchi(null, 0), new theloai(null, null)), new tinchi(maTinChi, 0),
					new theloai(maTheLoai, null), new hocky(maHocKy, null), new namhoc(maNamhoc, null),
					new Lop(0, null, new Khoa(null, null, null)));
		...
		for (Row row : sheet) {
			...
			for (Cell cell : row) {
				...
				case COLUMN_INDEX_MASV:
					...
					diem.setSinhvien(
							new sinhvien(msv, null, null, 0, null, new Lop(0, null, new Khoa(null, null, null))));
